...
export const PicturesSlider: FC = () => {
  ...
  const imagesUrl: Record<number, string> = {
    0: 'phones/apple-iphone-12-128gb-black',
    1: 'phones/apple-iphone-12-128gb-purple',
    2: 'phones/apple-iphone-12-128gb-red',
    3: 'phones/apple-iphone-12-128gb-white',
  };
